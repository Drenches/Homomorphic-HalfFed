...
datasets_part  = CIFAR10Partitioner(train_data.targets,
                                    ...
                                    partition="iid",
                                    seed=seed)
# train_sampler = SubsetRandomSampler(list(range(0, len(train_data), 10)))
...
#                                           shuffle=True)
train_loader = torch.utils.data.DataLoader(train_data, sampler=SubsetRandomSampler(datasets_part[0]), batch_size=128)
# test_loader = torch.utils.data.DataLoader(test_data, batch_size=1024,
#                                           shuffle=True)
