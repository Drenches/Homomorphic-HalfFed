...
train_dataset = CustomCIFAR10(root='data', train=True, transform=transform_train, target_labels=[0, 1], n=5)
test_dataset = CustomCIFAR10(root='data', train=False, transform=transform_test, target_labels=[0, 1], n=5)
